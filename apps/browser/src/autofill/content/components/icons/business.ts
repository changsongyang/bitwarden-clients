...
import { getIconColorRule, ruleNames, themes } from "../constants/styles";
...
export function Business({
  ...
  return html`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      <path
        class=${css(getIconColorRule(shapeColor, ruleNames.fill))}
        fill-rule="evenodd"
      ...
      />
      <path
        class=${css(getIconColorRule(shapeColor, ruleNames.stroke))}
